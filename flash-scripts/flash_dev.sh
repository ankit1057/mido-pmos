#!/bin/bash
# Flash Developer Phosh Variant (VS Code, Flutter, Python, Frappe Deps)
...
echo "Flashing Developer Phosh rootfs (sparse)..."
fastboot -S 128M flash userdata ../images/phosh_dev_sparse.img
echo "Rebooting..."
fastboot reboot
